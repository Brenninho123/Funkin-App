...
fun main() {
    val project = Project().apply {
        addLibrary("androidx.core:core-ktx", "1.12.0")
        addLibrary("androidx.compose.ui:ui", "1.6.0")
        addLibrary("androidx.compose.material3:material3", "1.2.0")

        addDefine("ANDROID_BUILD", "true")
    }
}
